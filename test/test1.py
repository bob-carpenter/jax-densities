...
log_density_value = model.log_density_unconstrained(data, params_unc)
print("Log Density Value (just value):", log_density_value)

log_density_v, log_density_g = jax.value_and_grad(model.log_density_unconstrained, argnums=1)(data, params_unc)
print("Log Density Value (combo):", log_density_v)
print("Log Density Gradient (combo):", log_density_g)

log_density_and_grad_jit = jax.jit(jax.value_and_grad(model.log_density_unconstrained, argnums=1))
